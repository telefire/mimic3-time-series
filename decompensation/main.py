...
if args.deep_supervision:
    train_data_gen = preprocessing.BatchGenDeepSupervision(train_data_loader, discretizer,
                                                   normalizer, args.batch_size, shuffle=True)
    val_data_gen = preprocessing.BatchGenDeepSupervision(val_data_loader, discretizer,
    ...
    if args.small_part:
        train_nbatches = 40
        val_nbatches = 40
    train_data_gen = preprocessing.BatchGen(train_reader, discretizer,
                                    normalizer, args.batch_size, train_nbatches, True)
    val_data_gen = preprocessing.BatchGen(val_reader, discretizer,
