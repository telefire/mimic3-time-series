...
xgreg = lgb.LGBMRegressor(objective='regression',num_leaves=5,learning_rate=0.07,n_estimators=10000)

eval_set = [(train_raw_reshape, train_raw[1]) , (val_raw_reshape, val_raw[1])]

xgreg.fit(train_raw_reshape, train_raw[1], eval_metric = 'auc,auroc', eval_set = eval_set, verbose = True, early_stopping_rounds = 80)
