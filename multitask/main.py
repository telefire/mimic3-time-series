...
from utils.readers import MultitaskReader
...
import in_hospital_mortality.preprocessing as ihm_utils
import decompensation.preprocessing as decomp_utils
import length_of_stay.preprocessing as los_utils
import phenotyping.preprocessing as pheno_utils
...
train_data_gen = preprocessing.BatchGen(reader=train_reader,
                                ...
                                shuffle=True)
val_data_gen = preprocessing.BatchGen(reader=val_reader,
                              discretizer=discretizer,
                              normalizer=normalizer,
                              ihm_pos=args_dict['ihm_pos'],
                              partition=args.partition,
